...
user1 = User.create!(username: 'billie')
user2 = User.create!(username: 'stevo')
artwork1 = Artwork.create!(title: 'Image1', image_url: 'google.com', artist_id: user1.id )
artwork2 = Artwork.create!(title: 'Image2', image_url: 'google1.com', artist_id: user2.id )
